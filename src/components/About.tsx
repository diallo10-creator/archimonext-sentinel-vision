...
const About = () => {
  return (
    <section id="apropos" className="py-12 sm:py-16 md:py-20 bg-corporate-light">
      <div className="container mx-auto px-4">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <div className="relative inline-block mb-4 sm:mb-6">
              <img 
                ...
                className="w-60 h-60 sm:w-80 sm:h-80 object-cover rounded-2xl shadow-corporate mx-auto lg:mx-0"
              />
              <div className="absolute -bottom-4 -right-4 bg-corporate-gold text-corporate-blue p-3 rounded-full shadow-gold">
                <Award className="h-8 w-8" />
              </div>
            </div>
            <h3 className="text-xl sm:text-2xl font-bold text-corporate-blue mb-2">
              M. Bohoussou Kouame Juste
            </h3>
            <p className="text-base sm:text-lg text-corporate-gold font-semibold mb-3 sm:mb-4">
              Gérant & Fondateur
            </p>
            <p className="text-sm sm:text-base text-corporate-gray leading-relaxed px-4 lg:px-0">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-corporate-blue mb-6 sm:mb-8">Nos Valeurs</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center px-4">
              <div className="bg-corporate-gold/10 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <CheckCircle className="h-6 w-6 sm:h-8 sm:w-8 text-corporate-gold" />
              </div>
              <h4 className="text-lg sm:text-xl font-semibold text-corporate-blue mb-2 sm:mb-3">Professionnalisme</h4>
